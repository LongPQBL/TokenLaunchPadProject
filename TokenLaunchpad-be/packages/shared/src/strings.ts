...
export const UI = {
  ...
  create: {
    ...
    errors: {
      ...
      website: "Enter a link that starts with http:// or https://.",
      twitter: "Enter a link to a twitter.com or x.com profile.",
      telegram: "Enter a link to a t.me group or channel.",
